...
/* harmony import */ var _modules_header_scroll_header_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/header-scroll/header-scroll */ "./js/modules/header-scroll/header-scroll.js");
/* harmony import */ var _modules_nojs_nojs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/nojs/nojs */ "./js/modules/nojs/nojs.js");
/* harmony import */ var _modules_feedback_scroll_feedback_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/feedback-scroll/feedback-scroll */ "./js/modules/feedback-scroll/feedback-scroll.js");
/* harmony import */ var _modules_feedback_scroll_feedback_scroll__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_feedback_scroll_feedback_scroll__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_show_content_show_content__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/show-content/show-content */ "./js/modules/show-content/show-content.js");
/* harmony import */ var _modules_show_content_show_content__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_show_content_show_content__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_footer_toogle_footer_toogle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/footer-toogle/footer-toogle */ "./js/modules/footer-toogle/footer-toogle.js");
/* harmony import */ var _modules_modal_focus_modal_focus__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/modal-focus/modal-focus */ "./js/modules/modal-focus/modal-focus.js");
/* harmony import */ var _modules_modal_focus_modal_focus__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_modal_focus_modal_focus__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _modules_mask_mask__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/mask/mask */ "./js/modules/mask/mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_mask_mask__WEBPACK_IMPORTED_MODULE_8__["createMask"])();
...
Object(_modules_nojs_nojs__WEBPACK_IMPORTED_MODULE_3__["removeActiv"])();
Object(_modules_header_scroll_header_scroll__WEBPACK_IMPORTED_MODULE_2__["breakpointChecker"])();
...
var buttonsScroll = document.querySelectorAll('.scroll-button');
var _iterator = _createForOfIteratorHelper(buttonsScroll),
  _step;
try {
  var _loop = function _loop() {
    var buttonScroll = _step.value;
    buttonScroll.addEventListener('click', function (e) {
      e.preventDefault();
      var link = buttonScroll.getAttribute('href');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _nojs_nojs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../nojs/nojs */ "./js/modules/nojs/nojs.js");

var onOpenAccordion = function onOpenAccordion(element) {
...
var onCloseAccordion = function onCloseAccordion(element) {
...
var onButtonClick = function onButtonClick(e) {
  ...
  if (!element.parentNode.classList.contains('is-active') || !element.classList.contains('is-active')) {
    Object(_nojs_nojs__WEBPACK_IMPORTED_MODULE_0__["removeActiv"])();
    onOpenAccordion(element);
    return;
  }
};
_nojs_nojs__WEBPACK_IMPORTED_MODULE_0__["titlesWrapper"].forEach(function (toogle) {
...
var headerHeidht = header.offsetHeight;
var breakpoint = window.matchMedia('(min-width:1024px)');
var onWindowScroll = function onWindowScroll() {
  var scrollDistance = window.scrollY;
  if (scrollDistance > 1) {
    header.classList.add('header--fixed');
    main.style.marginTop = "".concat(headerHeidht, "px");
  } else {
...
var inputsPhone = document.querySelectorAll('[data-mask="phone"]');
var MASK_OPTIONS = {
...
var createMask = function createMask() {
  if (inputsPhone) {
    inputsPhone.forEach(function (inputPhone) {
      Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(inputPhone, MASK_OPTIONS);
    });
  } else {
    return;
  }
...
var callback = document.querySelector('.navigation__callback');
var userNameModal = document.querySelector('[name="username"]');
...
/*!*********************************!*\
  !*** ./js/modules/nojs/nojs.js ***!
  \*********************************/
/*! exports provided: titlesWrapper, removeActiv */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "titlesWrapper", function() { return titlesWrapper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeActiv", function() { return removeActiv; });
var titlesWrapper = document.querySelectorAll('.title-wrapper');
var removeActiv = function removeActiv() {
  titlesWrapper.forEach(function (titleWrapper) {
...
var aboutbtn = document.querySelector('.about-content__button');
var aboutContent = document.querySelector('.about-content__subtitle');
var aboutHeight = aboutContent.style.height;
